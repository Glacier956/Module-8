...
number_second = int(input("Введите количество секунд: "))

for second in range (number_second, 0, -1):
  print ("Количество секунд:", second)
  reverse_timer = int(input("Вы готовы забрать еду? 1 - Да, 0 - Нет. "))
  if reverse_timer == 1:
    print ("Ваша еда готова, можете забрать. Таймер прерван на", str(second) + " секунде")
    break
else:
